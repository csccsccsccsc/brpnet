                ...
                with torch.no_grad():
                    ...
                    for i_data in range(n_data):
                        ...
                        if npatches>0:
                            ...
                            scio.savemat(dir_savefile + 'pred_res/'+str(i_data)+'.mat', {'instance':idx_instances[maxpad:(h0+maxpad), maxpad:(w0+maxpad)], 'instance_ori':tmp_instance[maxpad:(h0+maxpad), maxpad:(w0+maxpad)]})