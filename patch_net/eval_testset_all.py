        ...
        for ths in [5]:
            for pred_sz_type in pred_sz_type_list:
                ...
                for irnd, iseed in enumerate(range(0)):
                    ...
                    dir_savefile = './test/noaug_nodrop_'+loss_type+'_iouthsp'+str(ths)+'_dilation_'+str(dilation_rate)+'_sz'+str(cursz)+'_ds'+str(dilation_s)+'_dc'+str(dilation_c)+'_ifold'+str(ifold)+'_wtta/rnd_'+str(iseed)+'/'
